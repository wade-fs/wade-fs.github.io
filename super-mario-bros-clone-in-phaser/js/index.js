...
function preload() {
  game.load.spritesheet('tiles', 'assets/tiles_dctsfk.png', 16, 16);
  game.load.spritesheet('goomba', 'assets/goomba_nmbtds.png', 16, 16);
  game.load.spritesheet('mario', 'assets/mario_wjlfy5.png', 16, 16);
  game.load.spritesheet('coin', 'assets/coin_iormvy.png', 16, 16);

  game.load.tilemap('level', 'assets/3kk2g', null, Phaser.Tilemap.TILED_JSON);
}
